      ...
      <el-row :gutter="20">
        ...
        <el-col :span="16">
          <div class="grid-content" style="margin-top: 60px">
            <el-form ref="admin" :rules="rules" :model="admin" label-width="80px" label-position="left">
              ...
              <el-form-item label="生日" prop="birthday">
                <el-col :span="10" style="margin-left: -10px">
                  <el-date-picker type="date" placeholder="选择日期" v-model="admin.birthday"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      onSubmit() {
        this.$refs.admin.validate((valid) => {
          if (valid) {
            // 调用更新个人信息接口
            updateInformation(this.admin, this.roleId).then(
              response => {
                // 判断密码是否匹配，匹配，跳转到首页
    ...
    mounted() {
      // 当个人信息组件挂载，首先获取用户信息
      this.admin.adminId = this.name;
      this.admin.password = this.password;
      this.admin.name = this.realName;
      this.admin.telephone = this.telephone;
      this.admin.birthday = this.getDateBySplit(this.birthday);
      this.admin.sex = this.sex;
    }
  }
</script>
